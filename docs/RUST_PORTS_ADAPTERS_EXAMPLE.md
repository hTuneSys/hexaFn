...
- Data Models: [DATA_MODEL_CORE](DATA_MODEL_CORE.puml), [DATA_MODEL_TRIGGER](DATA_MODEL_TRIGGER.puml), [DATA_MODEL_RUN](DATA_MODEL_RUN.puml), [DATA_MODEL_STORE](DATA_MODEL_STORE.puml), [DATA_MODEL_CAST](DATA_MODEL_CAST.puml), [DATA_MODEL_BRIDGE](DATA_MODEL_BRIDGE.puml), [DATA_MODEL_WATCH](DATA_MODEL_WATCH.puml)
- Data Flow: [DATA_FLOW](DATA_FLOW.md), [DATA_FLOW_SAMPLE](DATA_FLOW_SAMPLE.md), [DATA_FLOW_DETAIL](DATA_FLOW_DETAIL.md)
